      ...
      <div className="container main-container">
        ...
        <div data-aos="fade-right" className="left-side">
          ...
          <div data-aos="fade-up" data-aos-delay="400" className="buttons-container">
            <a href="https://wa.me/5587991097916">
              <button
                className="btn-beige"
...
// Componentes de Elementos Decorativos
const DecorativeElements = () => (
  <>
    <span className="deco-symbol sym-1" data-aos="fade-down" data-aos-delay="300">
      $
    </span>
    <span className="deco-symbol sym-2" data-aos="fade-down" data-aos-delay="350">
      €
    </span>
    <span className="deco-symbol sym-3" data-aos="fade-down" data-aos-delay="400">
      R$
    </span>
    <span className="deco-symbol sym-4" data-aos="fade-down" data-aos-delay="450">
      ¥
    </span>
    <span className="deco-symbol sym-5" data-aos="fade-down" data-aos-delay="500">
      £
    </span>
    <span className="deco-symbol sym-6" data-aos="fade-down" data-aos-delay="550">
      ₿
    </span>
    <span className="deco-symbol sym-7" data-aos="fade-down" data-aos-delay="600">
      ₹
    </span>
    <span className="deco-symbol sym-8" data-aos="fade-down" data-aos-delay="650">
      ₩
    </span>
    <span className="deco-symbol sym-9" data-aos="fade-down" data-aos-delay="700">
      ₦
    </span>
    <span className="deco-symbol sym-10" data-aos="fade-down" data-aos-delay="750">
      ₫
    </span>
