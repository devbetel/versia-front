...
const OfferMentoring: React.FC<PricingMentoringProps> = ({
  ...
  useEffect(() => {
    ...
    const section = document.getElementById('pricing-mentoring');
    if (section) {
  ...
  return (
    <>
      ...
      <section className="pricing-mentoring-section" id="pricing-mentoring">
        <div className="pricing-container">
          <div className={`pricing-header-mentoring ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="pricing-grid-mentoring">
            {/* Essencial Autonomia */}
            <div className={`pricing-card-mentoring ${isVisible ? 'visible' : ''}`}>
              <div className="card-glow-mentoring"></div>
              <span className="card-tag-mentoring">Para quem quer autonomia</span>
              <div className="card-name-mentoring">Essencial Autonomia</div>
              
              <div className="card-price-wrapper-mentoring">
            ...
            {/* Experiência VIP */}
            <div className={`pricing-card-mentoring vip-card ${isVisible ? 'visible' : ''}`}>
              <div className="card-glow-mentoring"></div>
              <div className="badge-mentoring">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                  <path d="M5 1L6 4H9L7 6.5L8 9.5L5 8L2 9.5L3 6.5L1 4H4L5 1Z" fill="currentColor"/>
                </svg>
                Recomendado
              </div>
              <span className="card-tag-mentoring">Para quem quer ir além</span>
              <div className="card-name-mentoring">Experiência VIP</div>
          ...
          <div className={`pricing-footer-mentoring ${isVisible ? 'visible' : ''}`}>
            <p>
